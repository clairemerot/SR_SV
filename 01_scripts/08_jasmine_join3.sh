...
VCFlist=08_jasmine/"$BASE".list
OUTfile=08_jasmine/"$BASE".vcf
...
--normalize_type threads=$NB_CPU


bcftools query -f '%CHROM %POS %INFO/END %INFO/SVTYPE %INFO/SVLEN %INFO/SUPP_VEC %INFO/SUPP\n' $OUTfile > 08_jasmine/"$BASE".bed

bcftools filter -i'INFO/SUPP!="1"' -o 08_jasmine/"$BASE"_min2tools.vcf -Ov 08_jasmine/"$BASE".vcf

echo "nb of SV"
grep -v ^\#\# 08_jasmine/"$BASE".vcf | wc -l #80423

echo "nb of SV with at least 2 tools"
grep -v ^\#\# 08_jasmine/"$BASE"_min2tools.vcf | wc -l #29166
