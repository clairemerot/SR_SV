...
#mkdir 08_smoove/individual_vcf
#echo "call genotype for A18S02 with smoove"
#smoove call -p 1 --outdir 08_smoove/individual_vcf/ \
...
#step 2 merge
# this will create 08_smoove/merged.sites.vcf.gz
#mkdir 08_smoove/merged_vcf
#smoove merge --outdir 08_smoove/merged_vcf/ \
#--name merged \
#-f 02_info/genome.fasta \
#08_smoove/individual_vcf/*.genotyped.vcf.gz
#
...
#mkdir 08_smoove/individual_vcf_jointvariants
#smoove genotype -d -x -p 1 \
#--outdir 08_smoove/individual_vcf_jointvariants/ \
#--name A18S02-joint \
#--fasta 02_info/genome.fasta \
#--vcf 08_smoove/merged_vcf/merged.sites.vcf.gz \
...
#smoove paste --name 08_smoove/allsamples 08_smoove/individual_vcf_jointvariants/*.vcf.gz
